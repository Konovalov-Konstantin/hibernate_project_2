...
public class Film {
    ...
    @Convert(converter = RatingConverter.class) // ссылка на конвертер
    ...
    @JoinTable(name = "film_actor", // связующая таблица
            joinColumns = @JoinColumn(name = "film_id", // колонка из связующей таблицы
                    referencedColumnName = "film_id"),  // колонка из таблицы film
            inverseJoinColumns = @JoinColumn(name = "actor_id", // колонка из связующей таблицы
    ...
    @JoinTable(name = "film_category", // связующая таблица
            joinColumns = @JoinColumn(name = "film_id", // колонка из связующей таблицы
                    referencedColumnName = "film_id"),  // колонка из таблицы film
            inverseJoinColumns = @JoinColumn(name = "category_id", // колонка из связующей таблицы
